...
#ifdef HAVE_AVX2
        measure_total_time("AVX2 (generic)                      : ",
                           [this]{return is_sorted_avx2_generic(array, size);}, iterations);
        measure_total_time("AVX2 (generic, unrolled 4 times)    : ",
                           [this]{return is_sorted_avx2_generic_unrolled4(array, size);}, iterations);
        measure_total_time("AVX2                                : ",
                           [this]{return is_sorted_avx2(array, size);}, iterations);
