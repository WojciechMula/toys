...
void avx512_long_div_u8_ver2(const uint8_t* A, const uint8_t* B, uint8_t* C, size_t n) {
    const __m512i one = _mm512_set1_epi8(1);
    const __m512i msb = _mm512_set1_epi8((int8_t)0x80);
    ...
    for (size_t i=0; i < n; i += 64) {
        ...
        const __m512i a_bit7 = _mm512_min_epu8(_mm512_and_epi32(aa, msb), one);
        aa = _mm512_add_epi8(aa, aa);
        const __m512i a_bit6 = _mm512_min_epu8(_mm512_and_epi32(aa, msb), one);
        aa = _mm512_add_epi8(aa, aa);
        const __m512i a_bit5 = _mm512_min_epu8(_mm512_and_epi32(aa, msb), one);
        aa = _mm512_add_epi8(aa, aa);
        const __m512i a_bit4 = _mm512_min_epu8(_mm512_and_epi32(aa, msb), one);
        aa = _mm512_add_epi8(aa, aa);
        const __m512i a_bit3 = _mm512_min_epu8(_mm512_and_epi32(aa, msb), one);
        aa = _mm512_add_epi8(aa, aa);
        const __m512i a_bit2 = _mm512_min_epu8(_mm512_and_epi32(aa, msb), one);
        aa = _mm512_add_epi8(aa, aa);
        const __m512i a_bit1 = _mm512_min_epu8(_mm512_and_epi32(aa, msb), one);
        const __m512i a_bit0 = _mm512_and_epi32(a, one);
