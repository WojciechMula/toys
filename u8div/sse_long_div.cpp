void sse_long_div_u8_ver1(const uint8_t* A, const uint8_t* B, uint8_t* C, size_t n) {
...
void sse_long_div_u8_ver2(const uint8_t* A, const uint8_t* B, uint8_t* C, size_t n) {
...
void sse_long_div_u8_ver3(const uint8_t* A, const uint8_t* B, uint8_t* C, size_t n) {
