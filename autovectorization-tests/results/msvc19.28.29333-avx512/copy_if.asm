...
_x$ = 8                                       ; size = 1
bool <lambda_245997f49bbd5edecdf7ddcd5663fb6c>::operator()(signed char)const  PROC ; <lambda_245997f49bbd5edecdf7ddcd5663fb6c>::operator(), COMDAT
        cmp     BYTE PTR _x$[esp-4], 0
        setg    al
        ret     4
bool <lambda_245997f49bbd5edecdf7ddcd5663fb6c>::operator()(signed char)const  ENDP ; <lambda_245997f49bbd5edecdf7ddcd5663fb6c>::operator()
...
_x$ = 8                                       ; size = 4
bool <lambda_c6e75ef9f1a108f05d88b58a78f5dbf9>::operator()(int)const  PROC ; <lambda_c6e75ef9f1a108f05d88b58a78f5dbf9>::operator(), COMDAT
        cmp     DWORD PTR _x$[esp-4], 0
        setg    al
        ret     4
bool <lambda_c6e75ef9f1a108f05d88b58a78f5dbf9>::operator()(int)const  ENDP ; <lambda_c6e75ef9f1a108f05d88b58a78f5dbf9>::operator()
