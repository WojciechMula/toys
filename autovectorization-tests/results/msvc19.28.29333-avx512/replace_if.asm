_x$ = 8                                       ; size = 1
bool <lambda_fa112ba9c4d1de1c2d967867fa795941>::operator()(signed char)const  PROC ; <lambda_fa112ba9c4d1de1c2d967867fa795941>::operator(), COMDAT
...
$LN3@operator:
        mov     al, 1
        ret     4
bool <lambda_fa112ba9c4d1de1c2d967867fa795941>::operator()(signed char)const  ENDP ; <lambda_fa112ba9c4d1de1c2d967867fa795941>::operator()

_x$ = 8                                       ; size = 1
bool <lambda_f7563e17a6ce13a911f0a19ffb872b64>::operator()(signed char)const  PROC ; <lambda_f7563e17a6ce13a911f0a19ffb872b64>::operator(), COMDAT
        mov     al, BYTE PTR _x$[esp-4]
        cmp     al, 13                                    ; 0000000dH
        je      SHORT $LN3@operator
        cmp     al, -12                             ; fffffff4H
...
$LN3@operator:
        mov     al, 1
        ret     4
bool <lambda_f7563e17a6ce13a911f0a19ffb872b64>::operator()(signed char)const  ENDP ; <lambda_f7563e17a6ce13a911f0a19ffb872b64>::operator()
