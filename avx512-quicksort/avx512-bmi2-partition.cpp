...
void avx512_bmi2_align_masks(__mmask16& a, __mmask16& b, __mmask16& rem_a, __mmask16& rem_b) {
...
void avx512_bmi2_partition_epi32(uint32_t* array, uint32_t pv, int& left, int& right) {
    ...
    while (right - left + 1 >= 2*N) {
        ...
        avx512_bmi2_align_masks(maskL, maskR, mL, mR);
