...
void check_all() {
    ...
    puts("checking check_ada_pred");
    check_ada_pred();
    puts("checking check_ada_res");
    check_ada_res();
    puts("checking check_ada");
    check_ada();
    puts("checking check_adadefs");
    check_adadefs();
    puts("checking check_c");
    check_c();
    puts("checking check_countries");
    check_countries();
    puts("checking check_cplusplus");
    check_cplusplus();
    puts("checking check_cpp");
    check_cpp();
    puts("checking check_go");
    check_go();
    puts("checking check_gpc");
    check_gpc();
    puts("checking check_irc");
    check_irc();
    puts("checking check_java");
    check_java();
    puts("checking check_jscript");
    check_jscript();
    puts("checking check_modula");
    check_modula();
    puts("checking check_modula2");
    check_modula2();
    puts("checking check_modula3");
    check_modula3();
    puts("checking check_pascal");
    check_pascal();
    puts("checking check_sneller");
    check_sneller();
    puts("checking check_snellerbuiltin");
    check_snellerbuiltin();
    puts("checking check_states");
    check_states();
    puts("All OK");
}
