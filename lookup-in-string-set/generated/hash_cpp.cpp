...
int lookup_cpp_hash1(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[170] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[170] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_cpp_hash3(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[248] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[248] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_cpp_hash_sum0(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[180] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[180] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_cpp_hash_sumN(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[148] = {
        "this", // 444 (0x1bc)
        "",
        "auto", // 445 (0x1bd)
        "goto", // 445 (0x1bd)
    ...
    static constexpr const int values[148] = {
        39, // 444 (0x1bc)
        -1,
        1, // 445 (0x1bd)
        19, // 445 (0x1bd)
...
int lookup_cpp_hash_djb2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[304] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[304] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_cpp_hash_sdb(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[236] = {
        "",
    ...
    static constexpr const int values[236] = {
        -1,
