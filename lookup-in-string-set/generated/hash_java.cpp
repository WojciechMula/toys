...
int lookup_java_hash2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[130] = {
        "else", // 10205 (0x27dd)
        "",
    ...
    static constexpr const int values[130] = {
        16, // 10205 (0x27dd)
        -1,
        27, // 10596 (0x2964)
        -1,
...
int lookup_java_hash3(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[328] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[328] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_java_hash_sum0(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[112] = {
        "return", // 672 (0x2a0)
        "short", // 560 (0x230)
        "",
        "",
    ...
    static constexpr const int values[112] = {
        18, // 672 (0x2a0)
        23, // 560 (0x230)
        -1,
        -1,
...
int lookup_java_hash_sumN(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[126] = {
        "",
        "",
    ...
    static constexpr const int values[126] = {
        -1,
        -1,
        42, // 1324 (0x52c)
        -1,
...
int lookup_java_hash_djb2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[230] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[230] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_java_hash_sdb(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[365] = {
    ...
    static constexpr const int values[365] = {
