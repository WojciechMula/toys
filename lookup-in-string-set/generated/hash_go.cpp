...
int lookup_go_hash1(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[76] = {
        "chan", // 836 (0x344)
        "",
        "",
        "",
    ...
    static constexpr const int values[76] = {
        2, // 836 (0x344)
        -1,
        -1,
        -1,
...
int lookup_go_hash2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[54] = {
        "select", // 13338 (0x341a)
        "struct", // 13338 (0x341a)
    ...
    static constexpr const int values[54] = {
        20, // 13338 (0x341a)
        21, // 13338 (0x341a)
        4, // 9991 (0x2707)
        14, // 12178 (0x2f92)
...
int lookup_go_hash3(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[107] = {
        "",
        "",
        "defer", // 27180 (0x6a2c)
        "return", // 31033 (0x7939)
    ...
    static constexpr const int values[107] = {
        -1,
        -1,
        6, // 27180 (0x6a2c)
        19, // 31033 (0x7939)
...
int lookup_go_hash_sum0(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[73] = {
        "",
        "switch", // 658 (0x292)
        "",
        "goto", // 441 (0x1b9)
    ...
    static constexpr const int values[73] = {
        -1,
        22, // 658 (0x292)
        -1,
        12, // 441 (0x1b9)
...
int lookup_go_hash_sumN(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[63] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[63] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_go_hash_sdb(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[71] = {
    ...
    static constexpr const int values[71] = {
