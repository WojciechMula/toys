...
int lookup_gpc_hash1(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[110] = {
        "And", // 495 (0x1ef)
        "Begin", // 880 (0x370)
        "Or", // 386 (0x182)
        "",
    ...
    static constexpr const int values[110] = {
        0, // 495 (0x1ef)
        2, // 880 (0x370)
        21, // 386 (0x182)
        -1,
...
int lookup_gpc_hash2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[197] = {
        "",
        "",
        "And", // 6503 (0x1967)
        "",
    ...
    static constexpr const int values[197] = {
        -1,
        -1,
        0, // 6503 (0x1967)
        -1,
...
int lookup_gpc_hash_djb2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[117] = {
    ...
    static constexpr const int values[117] = {
...
int lookup_gpc_hash_sdb(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[219] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[219] = {
        -1,
        -1,
        -1,
        -1,
