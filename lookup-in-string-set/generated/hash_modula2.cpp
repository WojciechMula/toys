...
int lookup_modula2_hash1(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[122] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[122] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_modula2_hash_sum0(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[124] = {
        "",
        "",
    ...
    static constexpr const int values[124] = {
        -1,
        -1,
        6, // 745 (0x2e9)
        -1,
...
int lookup_modula2_hash_sumN(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[96] = {
        "CASE", // 288 (0x120)
        "",
        "IF", // 145 (0x91)
        "IMPORT", // 481 (0x1e1)
    ...
    static constexpr const int values[96] = {
        4, // 288 (0x120)
        -1,
        16, // 145 (0x91)
        18, // 481 (0x1e1)
...
int lookup_modula2_hash_djb2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[245] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[245] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_modula2_hash_sdb(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[204] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[204] = {
        -1,
        -1,
        -1,
        -1,
