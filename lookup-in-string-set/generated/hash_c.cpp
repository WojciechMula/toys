...
int lookup_c_hash1(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[151] = {
        "",
        "",
        "default", // 1512 (0x5e8)
        "",
    ...
    static constexpr const int values[151] = {
        -1,
        -1,
        27, // 1512 (0x5e8)
        -1,
...
int lookup_c_hash2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[152] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[152] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_c_hash3(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[121] = {
        "",
        "",
    ...
    static constexpr const int values[121] = {
        -1,
        -1,
        30, // 31583 (0x7b5f)
        -1,
...
int lookup_c_hash_sum0(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[90] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[90] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_c_hash_sumN(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[100] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[100] = {
        -1,
        -1,
        -1,
        -1,
...
int lookup_c_hash_djb2(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[109] = {
        "",
        "do", // 5972220 (0x5b20fc)
    ...
    static constexpr const int values[109] = {
        -1,
        1, // 5972220 (0x5b20fc)
...
int lookup_c_hash_sdb(std::string_view s) {
    ...
    static constexpr const std::string_view lookup[131] = {
        "",
        "",
        "",
        "",
    ...
    static constexpr const int values[131] = {
        -1,
        -1,
        -1,
        -1,
