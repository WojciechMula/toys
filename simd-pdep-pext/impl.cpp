...
function_names_t function_names() {
    ...
    names[scalar_pdep_u32] = "pdep scalar";
        ...
        names[avx512_pext_u32_ver2] = "pext AVX512 v2";
        names[avx512_pext_u32_ver2_6bits] = "pext AVX512 v2 (6 bit)";
        names[avx512_pext_u32_ver2_8bits] = "pext AVX512 v2 (8 bit)";
        names[avx512_pext_u32_ver2_16bits] = "pext AVX512 v2 (16 bit)";
        names[avx512_pext_u32_ver2_24bits] = "pext AVX512 v2 (24 bit)";
        names[avx512_pext_u32_ver2_ee] = "pext AVX512 v2 (early exit)";
        names[avx512_pext_u32_ver2_6bits_ee] = "pext AVX512 v2 (6 bit, early exit)";
        names[avx512_pext_u32_ver2_8bits_ee] = "pext AVX512 v2 (8 bit, early exit)";
        names[avx512_pext_u32_ver2_16bits_ee] = "pext AVX512 v2 (16 bit, early exit)";
        names[avx512_pext_u32_ver2_24bits_ee] = "pext AVX512 v2 (24 bit, early exit)";
